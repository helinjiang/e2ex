...
const urlHandle = __webpack_require__(3);
...
console.log('xxxxxxxxxxx', typeof __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a);
...
function getBannerInfo(containerDom) {
    var bannerContainerDom = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.$('.banner-list', containerDom);

    var result = {
        isExist: __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist(bannerContainerDom)
    };

    if (result.isExist) {
        // banner 图片的个数
        result.total = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getTotal('.nd-banner-scroller .nd-banner-item', bannerContainerDom);
    }
...
function getFeedsInfo(containerDom) {
    var result = {
        isExist: __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist('.feeds-list', containerDom),
        listCount: __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getTotal('.feeds-list', containerDom)
    };

    if (result.isExist) {
        // 直播
        var liveInfo = {};
        liveInfo.total = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getTotal('.feeds-list .display-feed-card-1 .type.live', containerDom);
        liveInfo.id_8 = getFeedsCard1Info('.id_8');
        liveInfo.id_10086 = getFeedsCard1Info('.id_10086');

        // 录播
        var recordInfo = {};
        recordInfo.total = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getTotal('.feeds-list .display-feed-card-1 .type.record', containerDom);
        ...
        // 录播
        var shortVideoInfo = {};
        shortVideoInfo.total = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getTotal('.feeds-list .display-feed-card-2', containerDom);
        shortVideoInfo.id_123 = getFeedsCard2Info('.id_123');
        shortVideoInfo.id_124 = getFeedsCard2Info('.id_124');

        // 加载中文案
        var loadingInfo = {};
        loadingInfo.isExist = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist('#nomore');
        loadingInfo.wording = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getText('#nomore p');
...
function getNoticeInfo(containerDom) {
    var noticeContainerDom = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.$('.notice-list', containerDom);

    var result = {
        isExist: __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist(noticeContainerDom)
    };

    if (result.isExist) {
        // banner 图片的个数
        result.total = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getTotal('.display-feed-card-3', noticeContainerDom);
        result.isExistTitle = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist('.notice-title', noticeContainerDom);
    }
...
function getFeedsCard1Info(curDom, containerDom) {
    if (typeof curDom === 'string') {
        curDom = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.$(`.feeds-list .display-feed-card-1${curDom}`, containerDom);
    }
    ...
    result.anchorName = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getText('.name', curDom);
    result.anchorNameStyle = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getStyle('.name', curDom);
    result.viewShow = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getText('.view', curDom);
    result.roomName = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getText('.room-name', curDom);
    result.roomNameStyle = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getStyle('.room-name', curDom);
    result.pic = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getBackgroundImageUrl('.feeds-card-item', curDom);
    result.anchorPic = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getBackgroundImageUrl('.avatar', curDom);
    result.tagPic = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getImageDomUrl('.tag img', curDom);
    result.style = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getStyle(curDom);
    result.isLive = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist('.type.live', curDom);
    result.isRecord = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist('.type.record', curDom);
...
function getFeedsCard2Info(curDom, containerDom) {
    if (typeof curDom === 'string') {
        curDom = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.$(`.feeds-list .display-feed-card-2${curDom}`, containerDom);
    }
    ...
    result.name = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getText('.name', curDom);
    result.nameStyle = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getStyle('.name', curDom);
    result.desc = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getText('.desc', curDom);
    result.descStyle = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getStyle('.desc', curDom);
    result.pic = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getBackgroundImageUrl('.lazyload-pic', curDom);
    result.style = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.getStyle(curDom);
    result.isSvc = __WEBPACK_IMPORTED_MODULE_0__modules_utils___default.a.isExist('.type.activity', curDom);
