...
class Builder {
     ...
     *
     * @param {Object}  params
     * @param {Boolean} params.distPath
     * @param {Boolean} params.srcPath
     * @param {Boolean} params.entryRelativePath
     * @param {Boolean} params.jsLoader
     * @param {Number}  params.minifyJS
     * @param {Object}  opts
     * @param {Boolean}  opts.isSimpleBuild
     * @example
     */
    static createProdConfig(params = {}, opts = {}) {
        ...
        prodPlugins.push(new CleanWebpackPlugin([params.distPath], {
            root: projectRoot,
            verbose: true,
            dry: false
        }));
        ...
        prodConfig.entry = Builder._getEntry(path.join(params.srcPath, params.entryRelativePath));
        prodConfig.output = {
            filename: '[name].js',
    ...
    static _setJsRule() {
        ...
        return { test: /\.js$/, loader: path.join(__dirname, './webpack-loader-insert-js') };
    }
