...
class Builder {
    ...
    static createProdConfig(params = {}, opts = {}) {
        ...
        if (!opts.isSimpleBuild) {
            // 设置JS解析规则
            prodRules.push(Builder._getAppendNightmareRule(params.entryRelativePath));
        }
    ...
    /**
     * 获得插入 nightmare 的脚本文件，只限定在打包文件中才使用，而不是所有js文件
     *
     * @param {String} entryRelativePath
     * @returns {{test: RegExp, loader: string}}
     * @private
     */
    static _getAppendNightmareRule(entryRelativePath) {
        return {
